...
mod session_commands {
    ...
    use flare_proto::signaling::{
        HeartbeatRequest, HeartbeatResponse, LoginRequest, LoginResponse, LogoutRequest,
        LogoutResponse,
    };
    ...
    impl SessionCommandService {
        pub fn new(signaling: Arc<dyn SignalingGateway>, gateway_id: String) -> Self {
            Self {
                signaling,
                gateway_id,
            }
...
pub use session_commands::{HeartbeatCommand, LoginCommand, LogoutCommand, SessionCommandService};
