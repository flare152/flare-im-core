...
use crate::interface::middleware::{AuthMiddleware, RateLimitMiddleware, RbacMiddleware, TenantMiddleware};
...
pub struct RequestContext {
    /// Token Claims
    pub claims: Option<crate::interface::middleware::auth::TokenClaims>,
    /// 租户上下文
...
/// 从请求扩展中提取Claims
pub fn extract_claims<T>(request: &Request<T>) -> Option<&crate::interface::middleware::auth::TokenClaims> {
    request.extensions().get::<crate::interface::middleware::auth::TokenClaims>()
}
